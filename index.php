  ...
  <div class="container py-4">
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        ...
        <p class="col-md-8 fs-4">Acá podras ver la fortuna que ganaras mes a mes cuando te jubiles, ya que tu no sabes calcularlo. Ideal para idotas que comunmente visitan nuestra pagina, menos el profesorsito.</p>
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-6">
        <div class="h-100 p-5 text-white bg-dark rounded-3">
          ...
          <p>Acá se puede consultar cuanto APV necesitas para tener una pension digna de el pc gamer mensual.</p>
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3">
          <h2>Donaciones</h2>
          <p>Done aquí para que tus streamers favoritos puedan comprar su pc de gama baja. Muchas Gracias por anticipado.</p>
